...
export default function NewsletterForm() {
  ...
  return (
    <div className="max-w-md mx-auto px-6 mt-12 text-center bg-gray-500/35 p-10 rounded-lg w-full">
      ...
      <form onSubmit={handleNewsletterSubmit} className="space-y-3">
        <input
          ...
          className="w-full px-4 py-2 bg-gray-800 border border-green-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition"
          required
        />
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 transition duration-200 font-medium disabled:opacity-70"
        >
          <Send size={16} />
